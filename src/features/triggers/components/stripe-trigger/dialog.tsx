...
const StripeTriggerDialog = ({ open, onOpenChange }: Props) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Configure this webhook URL in your Stripe Dashboard to trigger this workflow on payment events</DialogDescription>
        </DialogHeader>
        <div className="space-y-4 max-h-[70dvh] overflow-auto">
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ol className="text-sm text-muted-foreground space-y-1  list-decimal list-inside">
              ...
              <li>Selct events to listen for (e.g payment_intent.succeeded).</li>
